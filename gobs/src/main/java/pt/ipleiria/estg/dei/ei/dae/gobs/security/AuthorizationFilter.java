...
public class AuthorizationFilter implements ContainerRequestFilter {
    public static final Response ACCESS_DENIED = Response.status(Response.Status.UNAUTHORIZED).entity("Acesso negado.").build();
    public static final Response ACCESS_FORBIDDEN = Response.status(Response.Status.FORBIDDEN).entity("Acesso proibido.").build();
